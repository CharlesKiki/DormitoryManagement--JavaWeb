...
$("#goods").validate({
  rules: {
	...
	$.post("check1.action",{stuNum:oInput.value.toLowerCase()},
		//用jQuery来获取异步数据
		function(data){
  ...
  <body id="page">
    <sx:head/> 
    <center><h2>更新物品出入</h2></center>
    <br>
    <div  style="margin-left:28em;position:absolute;">
    <s:form action="goods_update" method="post" border="1" target="frameBord"  name="stu" theme="simple" id="goods">
